 ...
 Used with MySQL database in Netbeans. Named the data base "nsa" and there are 3 tables. 1st table name - "agent" - columns are - "id"-integer "Name"-varchar "AssignedSuspect"-int -- 2nd table name - "suspect" - columns are - "ID"-int "SuspectName"-varchar "Threat"-int "AssignedAgent"-int "LastSeen"-varchar(state or country) -- 3rd table name - "user" - columns are - "id"-int "username"-varchar "password"-varchar "Admin"-char (use 't' or 'f' representing true or false)
